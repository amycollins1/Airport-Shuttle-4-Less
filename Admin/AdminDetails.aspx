<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AdminDetails.aspx.cs" Inherits="Frederick.Admin.AdminDetails" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="Scripts/Admin.js"></script>
    <script src="Scripts/AdminDetails.js"></script>
</asp:Content>
        ...
        <section class="wrapper">
            ...
            <div class="row form-panel">
                <div class="col-lg-12 main-chart">
                    ...
                    <div class="row mt">
                        <div class="col-lg-12">
                            <div class="content-panel"><h3>Admin Details</h3>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="" align="center">Update Customer</h4>
                </div>
