...
namespace Frederick.Admin
{
    public partial class CustomerActivity : System.Web.UI.Page
    {
        ...
        protected void ExportToPDF(object sender, EventArgs e)
        {
            ...
            {
                List<tbl_Reservation> Data = (List<tbl_Reservation>)HttpContext.Current.Session["CustomerList"];
                DataTable List = DefaultManager.ConvertToDatatable(Data);
                sb.AppendLine("<h2>AirportShuttles4Less Customer Report</h2> ");
                ...
                sb.AppendLine("<th> Driver Name </th>");
                ...
                for (int i = 0; i < List.Rows.Count; i++)
                {
                    ...
                    sb.AppendLine("<td><b>" + ((List.Rows[i]["Gratuity"])?.ToString()).Split('^')[0] + "</b></td>");
                    //sb.AppendLine("<td><b>" + List.Rows[i]["ReservationID"] + "</b></td>");
                    sb.AppendLine("</tr>");
                }
                //sb.AppendLine("<tr>");
                ...
                string FileName = "Customer Report " + DateTime.Now.ToString("MM-dd-yyyy") + ".pdf";
