...
namespace Frederick.Admin.Handler
{
    ...
    public class ReportDownloader : IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            { 
                DataTable dtResult = null;
                if (HttpContext.Current.Session["YearlyReservationList"] != null)
                {
                    List<tbl_Reservation> Data = (List<tbl_Reservation>)HttpContext.Current.Session["YearlyReservationList"];
                    dtResult = DefaultManager.ConvertToDatatable(Data);
                    DataTable dtSelectedColumns = dtResult.DefaultView.ToTable(false, "ReservationId", "DriverName", "FirstName", "PhoneNo", "ReservationDate", "Service", "Source", "Destination", "TotalFare");
                    ExporttoExcelYearly(dtSelectedColumns);
                }
                else
                {
                    DataTable dtSelectedColumns = dtResult.DefaultView.ToTable(false, "ReservationID", "AssignedTo", "FirstName", "ContactNumber", "ReservationDate", "Service", "Source", "Destination", "TotalFare");
                    ExporttoExcelYearly(dtSelectedColumns);
                }
            }
        }
        ...
        public static void ExporttoExcelReservation(DataTable objdatatable, Decimal TotalFare, Decimal TotalBWIearning, string DriverArr, string Status)
        {
            ...
            HttpContext.Current.Response.Write(" <TR style='font-size:30.0pt; font-family:Helvetica Neue; text-align:center; background:#006699;color:white; text-align:center'><td colspan=" + objdatatable.Columns.Count + ">AirportShuttles 4Less Reservation Report</td></TR>");
        ...
        public static void ExporttoExcelDriver(DataTable objdatatable, Decimal TotalFare, Decimal Tip, Decimal TT, Decimal BWIearning, Decimal DriverEarning)
        {
            ...
            HttpContext.Current.Response.Write(" <TR style='font-size:30.0pt; font-family:Helvetica Neue; text-align:center; background:#006699;color:white; text-align:center'><td colspan=" + objdatatable.Columns.Count + ">AirportShuttles 4Less Driver Report</td></TR>");
            HttpContext.Current.Response.Write(" <TR>");
            //am getting my grid's column headers
            int columnscount = objdatatable.Columns.Count;
            ...
            else
            {
                ...
                HttpContext.Current.Response.Write("<Td>");
                HttpContext.Current.Response.Write("<b>");
                HttpContext.Current.Response.Write("Driver Earning (10% + Tip): ");
                ...
                HttpContext.Current.Response.Write("<Td>");
                HttpContext.Current.Response.Write("<b>");
                HttpContext.Current.Response.Write("A4SL Earning: ");
        ...
        public static void ExporttoExcelCustomer(DataTable objdatatable, Decimal TotalFare)
        {
            ...
            HttpContext.Current.Response.Write(" <TR style='font-size:30.0pt; font-family:Helvetica Neue; text-align:center; background:#006699;color:white; text-align:center'><td colspan=" + objdatatable.Columns.Count + ">AirportShuttles4Less Customer Report</td></TR>");
            HttpContext.Current.Response.Write(" <TR>");
            //am getting my grid's column headers
            int columnscount = objdatatable.Columns.Count;
        ...
        public static void ExporttoExcelYearly(DataTable objdatatable)
        {
            decimal TotalFare = (decimal)HttpContext.Current.Session["YearlyReservationAmount"];

            objdatatable.Columns["ReservationDate"].ColumnName = "Reservation Date";
            objdatatable.Columns["ReservationId"].ColumnName = "Reservation Id";
            objdatatable.Columns["DriverName"].ColumnName = "Driver Name";
            ...
            HttpContext.Current.Response.ContentType = "application/ms-excel";
            HttpContext.Current.Response.Write(@"<!DOCTYPE HTML PUBLIC ""-//W3C//DTD HTML 4.0 Transitional//EN"">");
            HttpContext.Current.Response.AddHeader("Content-Disposition", "attachment;filename=Yearly Report " + Today + ".xls");
            ...
            HttpContext.Current.Response.Write(" <TR style='font-size:40.0pt; font-family:Helvetica Neue; text-align:center; background:#006699;color:white; text-align:center'><td colspan=" + objdatatable.Columns.Count + ">AirportShuttles4Less </td></TR>");
            HttpContext.Current.Response.Write(" <TR>");
            //am getting my grid's column headers
            int columnscount = objdatatable.Columns.Count;
            ...
            else
            {
                ...
                HttpContext.Current.Response.Write(TotalFare.ToString().Replace("False", "Inactive").Replace("True", "Active"));
                HttpContext.Current.Response.Write("</b>");
                HttpContext.Current.Response.Write("</Td>");
                HttpContext.Current.Response.Write("</TR>");
                HttpContext.Current.Response.Write("</Table>");
