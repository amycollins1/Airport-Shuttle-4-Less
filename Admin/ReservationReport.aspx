<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ReservationReport.aspx.cs" Inherits="Frederick.Admin.ReservationReport" %>
                    ...
                    <li>
                                          ...
                                          <div class="task-title">                                            
                                              ...
                                              <div class="pull-right hidden-phone">
                                                  <button type="button" class="btn  btn-success btn-xs" onclick="mCompleteBooking()"><i class="fa fa-check"></i> Complete Selected</button> 
                                                  <button type="button" class="btn  btn-warning btn-xs" onclick="mCancel()"><i class="fa fa-times"></i> Cancel Selected</button>  
                                                  <button type="button" class="btn  btn-danger btn-xs" onclick="mDelete()"><i class="fa fa-trash-o"></i> Delete Selected</button>   
                                              </div>
                                          </div>
                                      </li>
                        </ul>
