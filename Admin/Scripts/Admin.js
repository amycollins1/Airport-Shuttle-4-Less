...
function GetAllDriverCustomer() {
    $.ajax({
        url: "Handler/AdminHandler.asmx/GetAllDriverCustomer",
        type: "POST",
        data: '{}',
...
function GetAllVehicle() {
    $.ajax({
        url: "Handler/AdminHandler.asmx/GetAllVehicle",
        type: "POST",
        data: '{}',
        contentType: "application/json",
        datatype: "json",
...
function LoadFredrickVehicles(VehclId) {
    ...
    $.ajax({
        type: "POST",
        url: "Handler/AdminHandler.asmx/LoadFredrickCars",
...
function AddCustomer() {
    ...
    $.ajax({
        type: "POST",
        url: "Handler/AdminHandler.asmx/AddCustomer",
...
function AddAdmin() {
    ...
    $.ajax({
        type: "POST",
        url: "Handler/AdminHandler.asmx/AddAdmin",
        data: JSON.stringify({ Obj: DataArr }),
        contentType: "application/json",
        datatype: "json",
        success: function (response) {
...
function AddDispatcher() {
    ...
    $.ajax({
        type: "POST",
        url: "Handler/AdminHandler.asmx/AddDispatcher",
        data: JSON.stringify({ Obj: DataArr }),
        contentType: "application/json",
        datatype: "json",
        success: function (response) {
...
function GetHaltSettings() {
    $.ajax({
        url: "Handler/AdminHandler.asmx/GetHaltSettings",
        type: "POST",
        data: '{}',
        contentType: "application/json",
        datatype: "json",
