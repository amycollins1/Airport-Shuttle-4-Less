<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="User.aspx.cs" Inherits="Frederick.Admin.UserType" %>
        ...
        <section class="wrapper">
            ...
            <div class="row form-panel">
                <div class="col-lg-12 main-chart">
                    ...
                    <div class="row mt">
                        <div class="col-lg-12">
                            <div class="content-panel"><h3>User Details</h3>
            ...
            <div class="modal-content">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="UUserType">
                  <option value="Admin">Admin</option>
                                <option value="Customer">Customer</option>
                                <option value="Dispatcher">Dispatcher</option>
                </select>
