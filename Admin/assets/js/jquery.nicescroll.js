		...
		Q = function (h, c) {
		    ...
		    this.init = function () {
		        ...
		        if (!b.ispage || !g.cantouch &&
		            ...
		            c.css({
		                ...
		                top: 0,
		                //"float": "right", changed
		                "margin": "0 auto", // float change to margin.
		                //width: b.opt.cursorwidth, changed
		                width: b.opt.cursorwidth*2,
		                height: "0px",
		                //"background-color": b.opt.cursorcolor, changed
		            ...
		            for (q in x) h = x[q], (l = b.opt.railpadding[h]) ? f.css("padding-" + h, l + "px") : b.opt.railpadding[h] =
						0;
		            f.append(c);
		            //f.width = Math.max(parseFloat(b.opt.cursorwidth), c.outerWidth()) + b.opt.railpadding.left + b.opt.railpadding.right; changed
		            f.width = Math.max(parseFloat(b.opt.cursorwidth) * 2.5, c.outerWidth()) + b.opt.railpadding.left + b.opt.railpadding.right;
		            f.css({
		                width: f.width + "px",
		                zIndex: b.zindex,
		                background: "#a91c2a",
		    ...
		    this.doZoomIn = function (c) {
		        if (!b.zoomactive) {
		            ...
		            ("" == k || /transparent|rgba\(0, 0, 0, 0\)|rgba\(0,0,0,0\)/.test(k)) && b.win.css("backgroundColor", "#FFF5EE");
		            b.rail.css({
		                "z-index": y + 101
		            });
		            b.zoom.css({
