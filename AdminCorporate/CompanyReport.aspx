<%@ Page Title="" Language="C#" MasterPageFile="~/AdminCorporate/admincorporate.Master" AutoEventWireup="true" CodeBehind="CompanyReport.aspx.cs" Inherits="Frederick.AdminCorporate.CompanyReport" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="Scripts/CompanyReport.js"></script>
</asp:Content>
                ...
                <div class="col-lg-12 main-chart">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1 mb" style="padding-top: 2.1%">
                            <input type="button" class="btn btn-primary" value="Search" id="btn_Search" onclick="CompanyResReport();">
                        </div>
