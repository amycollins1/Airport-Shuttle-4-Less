...
function CompanyResReport() {
    ...
    var Data = { From: From, To: To, CompanyName: $("#Select_CompanyName option:selected").val() };
    $.ajax({
        type: "POST",
        url: "Handler/CorporativeHandler.asmx/CompanyResReport",
        ...
        success: function (response) {
            ...
            if (result.retCode == 1) {
                ...
                $("#BWIAmount").text('BWI Amount: ' + BWIAmount);
            }
        },
    });
}
...
function ExportToExcel() {
    window.location.href = "Handler/CorpExpToExcelHandler.ashx?datatable=" + 'dtCompany&Name=' + $('#Select_CompanyName option:selected').val()
}
