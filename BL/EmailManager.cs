...
namespace Frederick.BL
{
    ...
    { 
        public static string MailCredentials(string To, bool IsCC, string CCEmails, string Body, string Subject)
        {
            var message = new MailMessage();
            try
            {
                var fromAddress = new MailAddress("info@airportshuttles4less.com", "AirportShuttles4Less");
                ...
                var mailObj = new SmtpClient("relay-hosting.secureserver.net", 25)
                {
                    Credentials = new NetworkCredential("info@airportshuttles4less.com", "$buggy987"),
                ...
                System.Diagnostics.Debug.WriteLine($"Email sent successfully to: {To}, Subject: {Subject}");
                return "{\"retCode\":\"1\"}";
            }
            catch (Exception ex)
            {
                // Enhanced error logging
                System.Diagnostics.Debug.WriteLine($"Email send failed to: {To}, Error: {ex.Message}");
        ...
        public static string MailHeader()
        {
            ...
            sb.Append("<title>airportshuttle4less.com - Customer Receipt</title>  ");
            sb.Append("<style>                                            ");
        ...
        public static string MailTermsAndCondition()
        {
            ...
            sb.Append("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Online: www.airportshuttles4less.com<br>");
            ...
            sb.Append("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- A minimum fee of $250.00 will be charged for any extraordinary interior cleaning required.<br>");
            ...
            sb.Append("<b>14. Unusual delays or Mechanical breakdowns</b><br>");
            sb.Append("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- We will not be held liable for safekeeping of any items left in the vehicle. <br>");
            sb.Append("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- We are not responsible for delays or termination due to severe weather or unsafe road conditions. We will not be held liable in the event of a mechanical breakdown and will only be responsible for making up lost time at a mutually agreed upon date.<br>");
            sb.Append("	</td>                    ");
            sb.Append("	</tr>                    ");
        ...
        public static string CustomerBody(string ResId)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(Booking.CardType))
                {
                    sb.Append("<tr>");
                    sb.Append("<td class='heading'>Payment Method:</td>");
                    
                    if (Booking.PaymentType == "Credit Card")
                    {
                        sb.Append("<td>Credit Card - " + Booking.CardType + "**" + Booking.CardLast4 + "");
                    }
                    else
                    {
                ...
                sb.Append("");
                sb.Append("<tr>");
                sb.Append("<td class='heading'>Gratuity(" + (Booking.Gratuity).Split('^')[1] + "%):</td>");
                ...
                if (Booking.DriverId != 0)
                {
                    ...
                    sbDriver.Append("  	</tr>");
                    sbDriver.Append("  	<tr>");
                    sbDriver.Append("    	  <td colspan='13' style='border-bottom:thin solid green;'><br>Hello, " + Driver.FirstName + " " + Driver.LastName + " You have been assigned a job with the following details. If any information appears to be incorrect, please contact our office immediately for corrections. <br>&nbsp;</td>");
                    sbDriver.Append("	</tr>");
                    sbDriver.Append("      </tbody></table>");
                    sbDriver.Append("      <table width='100%' cellspacing='0' cellpadding='0'>");
                    sbDriver.Append("	<tbody><tr>");
                    ...
                    if (!string.IsNullOrEmpty(Booking.Airlines))
                    ...
                    else
                    {
                        ...
                        sbDriver.Append("	<tr>");
                        sbDriver.Append("	  <td class='heading'>Service: </td>          ");
                        if (Booking.Service == "From Airport" || Booking.Service == "To Airport") 
                            sbDriver.Append("	  <td width='75%'> Airport Transport Service</td>          "); 
                        else if (Booking.Service == "Frederick-From Airport" || Booking.Service == "Frederick-To Airport")
                            sbDriver.Append("	  <td width='75%'>Fredrick Service</td>          ");
                        else
                            sbDriver.Append("	  <td width='75%'>"+ Booking.Service + "</td>          ");
                        ...
                        if (Booking.Service == "To Airport" || Booking.Service == "To Airport Shuttle")
                        {
                            sbDriver.Append("	  <td class='heading'>Destination: </td>          ");
                ...
                if (Booking.Status == "Cancelled")
                    ...
                    Subject = "Driver Assignment Job - " + Booking.ReservationId;
        ...
        public static string BookingDetails(tbl_Reservation Booking)
        {
            ...
            if (Booking.Service == "From Airport" || Booking.Service == "To Airport")
                sb.Append("<td width='75%'>Airport Transport Services</td>");
            else if (Booking.Service == "Frederick-From Airport" || Booking.Service == "Frederick-To Airport")
                sb.Append("<td width='75%'>Fredrick Services</td>");  
            else
                sb.Append("<td width='75%'>" + Booking.Service + "</td>");
            sb.Append("</tr>");
            sb.Append("	<tr>                                                                                                    ");
        ...
        public static string QuoteMail(string first_name, string last_name, string pick_up_date, string pick_up_time, string pick_up_location, string destination, string service_type, string vehicle_type, string hours, string passengers, string phone, string email, string message, string current_page_url, string CCEmails)
        {
            #region Email Template
            string EmailTemplate = "<html><body>" +
                                        "<div align=\"center\">" +
                                        "<table style=\"width:90%;border:silver 1px solid\" cellspacing=\"0\" cellpadding=\"0\">" +
                                        "<tr>" +
                                        "<td width=\"100%\" style=\"vertical-align:top;text-align:center;padding:6px 5px 0px 5px;height:40px;FONT-FAMILY: Verdana;color:White; FONT-SIZE: 14px;background-color:Black\"><span>Quote Enquiry Mail</span></td>" +
                                        "</tr>" +

                                        "<tr>" +
                                        "<td width=\"100%\" style=\"vertical-align:top;text-align:left;padding:6px 5px 6px 5px;height:50px;FONT-FAMILY: Verdana;FONT-SIZE: 14px\"><b>First Name:</b> " + first_name + "</td>" +
                                        "</tr>" +

                                        "<tr>" +
                                        "<td width=\"100%\" style=\"vertical-align:top;text-align:left;padding:6px 5px 6px 5px;height:50px;FONT-FAMILY: Verdana;FONT-SIZE: 14px\"><b>Last Name:</b> " + last_name + "</td>" +
                                        "</tr>" +

                                        "<tr>" +
                                        "<td width=\"100%\" style=\"vertical-align:top;text-align:left;padding:6px 5px 6px 5px;height:50px;FONT-FAMILY: Verdana;FONT-SIZE: 14px\"><b>Pick_up Date:</b> " + pick_up_date + "</td>" +
                                        "</tr>" +

                                        "<tr>" +
                                        "<td width=\"100%\" style=\"vertical-align:top;text-align:left;padding:6px 5px 6px 5px;height:50px;FONT-FAMILY: Verdana;FONT-SIZE: 14px\"><b>Pick_up Time:</b> " + pick_up_time + "</td>" +
                                        "</tr>" +

                                         "<tr>" +
                                        "<td width=\"100%\" style=\"vertical-align:top;text-align:left;padding:6px 5px 6px 5px;height:50px;FONT-FAMILY: Verdana;FONT-SIZE: 14px\"><b>Pick_up Location:</b> " + pick_up_location + "</td>" +
                                        "</tr>" +

                                        "<tr>" +
                                        "<td width=\"100%\" style=\"vertical-align:top;text-align:left;padding:6px 5px 6px 5px;height:50px;FONT-FAMILY: Verdana;FONT-SIZE: 14px\"><b>Destination:</b> " + destination + "</td>" +
                                        "</tr>" +

                                         "<tr>" +
                                        "<td width=\"100%\" style=\"vertical-align:top;text-align:left;padding:6px 5px 6px 5px;height:50px;FONT-FAMILY: Verdana;FONT-SIZE: 14px\"><b>Service_type:</b> " + service_type + "</td>" +
                                        "</tr>" +

                                        "<tr>" +
                                        "<td width=\"100%\" style=\"vertical-align:top;text-align:left;padding:6px 5px 6px 5px;height:50px;FONT-FAMILY: Verdana;FONT-SIZE: 14px\"><b>Vehicle Type:</b> " + vehicle_type + "</td>" +
                                        "</tr>" +

                                         "<tr>" +
                                        "<td width=\"100%\" style=\"vertical-align:top;text-align:left;padding:6px 5px 6px 5px;height:50px;FONT-FAMILY: Verdana;FONT-SIZE: 14px\"><b>Hours:</b> " + hours + "</td>" +
                                        "</tr>" +

                                        "<tr>" +
                                        "<td width=\"100%\" style=\"vertical-align:top;text-align:left;padding:6px 5px 6px 5px;height:50px;FONT-FAMILY: Verdana;FONT-SIZE: 14px\"><b>Passengers:</b> " + passengers + "</td>" +
                                        "</tr>" +
                                        ...
                                        "<tr>" +
                                        "<td width=\"100%\" style=\"vertical-align:top;text-align:left;padding:6px 5px 6px 5px;height:50px;FONT-FAMILY: Verdana;FONT-SIZE: 14px\"><b>Email ID:</b> " + email + "</td>" +
                                        "</tr>" +
                                        ...
                                        "<tr>" +
                                        "<td width=\"100%\" style=\"vertical-align:top;text-align:left;padding:6px 5px 6px 5px;height:50px;FONT-FAMILY: Verdana;FONT-SIZE: 14px;background-color:#f0f0f0;\"><b>Page URL:</b> <a href=\"" + current_page_url + "\">" + current_page_url + "</a></td>" +
                                        "</tr>" +
            ...
            string Res = MailCredentials("airportshuttle4less@gmail.com", false, CCEmails, EmailTemplate, "Enquiry Mail");
            return Res;
        }
        ...
        public static string CorpEmail(tbl_CorpReservation Res, List<tbl_CorpReservationDetail> ResDet, bool IsCorp, bool IsDriver, bool IsBWI)
        {
            ...
            try
            {
                ...
                sb.Append("      <table width='100%'>");
                sb.Append("        <tbody><tr>");
                //sb.Append("          <td colspan='2' width='100%' class='heading'><b>AirportShuttles 4Less</b></td>");
                sb.Append("        </tr>");
                //sb.Append("        <tr>");
                ...
                sb.Append("  	</tr>");
                sb.Append("  	<tr>");
                sb.Append("    	  <td colspan='13' style='border-bottom:thin solid green;'><br>Thank you for traveling with AirportShuttles 4Less!  Below please find your confirmation. If any of the information appears to be incorrect, please contact our office immediately to correct it.<br>&nbsp;</td>");
                sb.Append("	</tr>");
                sb.Append("      </tbody></table>");
                sb.Append("      </tbody></table>");
                ...
                sb.Append("5. AirportShuttles 4Less is not liable for any personal or material damages arising from misconduct of his/her party.<br>");
                ...
                sb.Append("9. Guest acknowledges that AirportShuttles 4Less requires a service fee for late night service (11:00 PM to 5:00 AM).<br>");
                sb.Append("10. Guest acknowledges that AirportShuttles 4Less requires an additional service fee for incoming International flights.<br>");
                sb.Append("11. AirportShuttles 4Less is not held responsible for mechanical problems, inclement weather, or other uncontrollable circumstances resulting in the driver’s inability to start a service as it is scheduled or complete a service.<br>");
                sb.Append("12. In the event that the requested vehicle cannot be provided by AirportShuttles 4Less, a vehicle of equal quality will be provided.<br>");
                sb.Append("13. AirportShuttles 4Less reserves the right to adjust rates without notice. Rate changes may be the result of:<br>");
                ...
                try
                {
                    var message = new MailMessage
                    {
                        From = new MailAddress("reservation@bwishuttleservice.com"),
                        Subject = Res.Status == "Completed" 
                            ? "Receipt Booking-" + Res.ReservationNo
                            : Res.Status == "Cancelled" 
                                ? "Booking Cancelled-" + Res.ReservationNo
                                : "Confirmation for AirportShuttles 4Less Reservation made for " + Res.CompanyName + " " + Res.ReservationDate,
                        IsBodyHtml = true,
                        Body = ClientMail
                    };
                    ...
                    try
                    {
                        ...
                        var mailObj = new SmtpClient("relay-hosting.secureserver.net", 25)
                        {
                            Credentials = new NetworkCredential("reservation@bwishuttleservice.com", "aBC$32#2SDI_&%12"),
                            DeliveryMethod = SmtpDeliveryMethod.Network,
                            EnableSsl = false
                        };
                ...
                if (IsDriver)
                {
                    // IDE0017: Object initialization can be simplified - Fixed
                    var message = new MailMessage
                    {
                        From = new MailAddress("reservation@bwishuttleservice.com"),
                        Subject = Res.Status == "Cancelled" 
                            ? "Booking Cancelled-" + Res.ReservationNo
                            : "You have Booking -" + Res.ReservationNo,
                        IsBodyHtml = true,
                        Body = DriverMail
                    };
