...
namespace Frederick.BL
{
    public class EmailManager
    {
        ...
        public static string QuoteMail(string first_name, string last_name, string pick_up_date, string pick_up_time, string pick_up_location, string destination, string service_type, string vehicle_type, string hours, string passengers, string phone, string email)
        {
            #region Email Template
            string EmailTemplate = "<html><body>" +
                                        "<div align=\"center\">" +
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            message.Subject = "Confirmation for AirportShuttles 4Less Reservation made for " + Res.CompanyName + " " + Res.ReservationDate;
                        }
                        message.IsBodyHtml = true;
