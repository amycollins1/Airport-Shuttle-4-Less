...
namespace Frederick.Handler
{
    ...
    public class DefaultHandler : System.Web.Services.WebService
    {
        ...
        [WebMethod(true)]
        public string QuoteMail(string first_name, string last_name, string pick_up_date, string pick_up_time, string pick_up_location, string destination, string service_type, string vehicle_type, string hours, string passengers, string phone, string email)
        {
            try
            {
                EmailManager.QuoteMail(first_name, last_name, pick_up_date, pick_up_time, pick_up_location, destination, service_type, vehicle_type, hours, passengers, phone, email);
