                    ...
                    var List = (from ObjVehInfo in DB.tbl_VehInfos
                               join rates in DB.tbl_RateFredricks on ObjVehInfo.Sid equals rates.VehicleId
                                ...
                                select new
                                {
                                    ...
                                    MaxCapacity= ObjVehInfo.MaxCapacity.GetValueOrDefault(), 
                                    MaxBaggage = ObjVehInfo.MaxBaggage.GetValueOrDefault(),
                                    MinCapacity = ObjVehInfo.MinCapacity.GetValueOrDefault(),
                                    MinBaggage = ObjVehInfo.MinBaggage.GetValueOrDefault(),
