                ...
                <div class="col-lg-12 main-chart">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1 mb">
                            ...
                            <input type="number" id="Passengers" class="form-control" min="0" disabled="disabled" />
                        </div>
                         <div class="col-md-3 mb">
                   ...
                   <div class="col-md-3 mb">
                         ...
                         <div class="col-md-6 mb">
                          ...
                          <div class="col-md-3 mb">
                               ...
                               <input id="ExtraAdult" class="form-control" value="0" readonly="" style="display:none;">
                               <input id="ExtraAdultPrice" class="form-control" value="0.00" readonly="">
                          </div>
                         <div class="col-md-3 mb">
                               <label for="email">Extra Children :</label>
                               <input id="ExtraChild" class="form-control" value="0" readonly="" style="display:none;">
