<%@ Page Title="" Language="C#" MasterPageFile="~/AdminCorporate/admincorporate.Master" AutoEventWireup="true" CodeBehind="AddCorpReservation.aspx.cs" Inherits="Frederick.AdminCorporate.AddReservation" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        google.maps.event.addDomListener(window, 'load', function () {
            ...
            new google.maps.places.SearchBox(document.getElementById('txt_Pickup'));
            directionsDisplay = new google.maps.DirectionsRenderer({ 'draggable': true });

            var places1 = new google.maps.places.Autocomplete(document.getElementById('txt_Pickup'));
        ...
        google.maps.event.addDomListener(window, 'load', function () {
            ...
            new google.maps.places.SearchBox(document.getElementById('txt_Drop'));
            directionsDisplay = new google.maps.DirectionsRenderer({ 'draggable': true });

            var places1 = new google.maps.places.Autocomplete(document.getElementById('txt_Drop'));
            google.maps.event.addListener(places1, 'place_changed', function () {
    ...
    <script src="Scripts/AddCopReservation.js"></script>
</asp:Content>
                ...
                <div class="col-lg-12 main-chart">
                    <div class="row">
                        <div class="col-md-12 mb">
                            <h3>Add Reservation Detail</h3>
                            <h4 style="text-align:center; color: rgb(220, 53, 69);display:none" id="ResNo">Reservation No: BWIRESTest India-00001</h4>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb">
                            <label>Service :</label>
                            <select onchange="PassengerBind()" class="form-control" id="Select_Service">
                        ...
                        <div class="col-md-4 mb">
                            ...
                            <select onchange="PassengerBind('Change')" id="Select_Passenger" name="Drop[]" class="form-control">
                    ...
                    <div class="row" id="PassengerDetail">
                        <h4 align="center" id="">Passenger 1</h4>
                        <div class="col-md-4 mb">
                            <label for="email">First Name :</label>
                            <input id="txt_fName1" class="form-control" placeholder="First Name" />
                        </div>
                        <div class="col-md-4 mb">
                            <label for="email">Last Name :</label>
                            <input id="txt_lName1" class="form-control" placeholder="Last Name" />
                        </div>
                        <div class="col-md-4 mb">
                            <label for="email">Contact Number:</label>
                            <input id="txt_MobileNo1" class="form-control" list="Select_ContactNumber" />
                        </div>
                        <div class="col-md-4 mb">
                            <label for="email">Airlines / Flight :</label>
                            <input id="Select_Airline1" class="form-control" list="Select_Airline" name="Select_Airline">
                            <datalist id="Select_Airline">
                                ...
                                <option value="AerolÃ­neas Argentinas">AerolÃ­neas Argentinas</option>
                                <option value="AerolÃ­neas MAS">AerolÃ­neas MAS</option>
                                ...
                                <option value="Air Class LÃ­neas AÃ©reas">Air Class LÃ­neas AÃ©reas</option>
                                ...
                                <option value="SOL lÃ­nea aÃ©reas">SOL lÃ­nea aÃ©reas</option>
                        ...
                        <div class="col-md-4 mb">
                            ...
                            <input id="txt_FlightNo1" class="form-control" placeholder="Flight Number">
                        </div>
                        <div class="col-md-4 mb">
                            <label id="txt_Time1">Time :</label>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb">
                            ...
                            <select onchange="ChangeCompany()" class="form-control" id="Select_Company">
                            </select>
                        </div>
                        <div class="col-md-4 mb">
                            <label for="Address">Pickup Address:</label>
                            <input id="txt_Pickup" class="form-control" placeholder="Pickup Address">
                        </div>
                        <div class="col-md-4 mb">
                            <label for="Address">Drop Address:</label>
                            <input id="txt_Drop" class="form-control" placeholder="Drop Address">
                        </div>

                        <div class="col-md-4 mb">
                            <label for="Address">Assign Driver:</label>
                            <select class="form-control" id="Select_Driver">
                            </select>
                        </div>
                        <div class="col-md-4 mb">
                            <label for="Address">Credit Card:</label>
                            <input id="chkCredit" type="checkbox" style="margin-top: 30px;">
                        </div>
                        <div class="col-md-4 mb">
                            <label for="Address">Total Amount:</label>
                            <input type="number" id="txt_TotalAmount" placeholder="" class="form-control" autocomplete="off">
                        </div>
                        <div class="col-md-12 mb">
                            <label for="email">Remarks :</label>
                            <textarea id="txt_Remark" class="form-control" placeholder="Remarks"></textarea>
                        </div>
                        ...
                        <div class="col-md-2 mb">
                            <label for="Address">Corporate:</label>
                            <input id="chkCorpEmail" type="checkbox" onclick="CheckCorpEmail()">
                        </div>
                        <div class="col-md-2 mb">
                            <label for="Address">Driver  :</label>
                            <input id="chkDriverEmail" type="checkbox" onclick="CheckDriverEmail()">
                        </div>
                        <div class="col-md-2 mb">
                            <label for="Address">BWI:</label>
                            <input id="chkBWIEmail" type="checkbox" onclick="CheckBWIEmail()">
                        </div>

                    </div>
                    <div class="row">
                        <div class="col-md-2 mb">
                            <input id="btn_RegiterAgent" type="button" value="Save" class="btn btn-primary" onclick="Submit();" title="Submit Details">
                            <input type="button" value="Cancel" class="btn btn-primary" onclick="window.location.href = 'AddReservation.aspx'">
                        </div>
                    </div>
                </div>
        </section>
