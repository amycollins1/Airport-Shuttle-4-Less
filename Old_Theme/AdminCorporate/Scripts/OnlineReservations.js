        ...
        success: function (response) {
            ...
            if (obj.retCode == 1) {
                ...
                for (var i = 0; i < Arr.length; i++) {
                    ...
                    {
                        Div += '<td><button type="button" onclick="RedirectToUpdate(\'' + Arr[i].Sid + '\',\'' + Arr[i].Service + '\')" class="btn btn-primary btn-xs glyphicon glyphicon-edit" title="Edit"></button> | <button type="button" onclick="ConfirmBookingPopup(' + Arr[i].Sid + ')" class="btn btn-primary btn-xs glyphicon glyphicon-ok" title="Confirm" Disabled="Disabled"></button></td>'
                    }
                    else
                    {
                        Div += '<td><button type="button" onclick="RedirectToUpdate(\'' + Arr[i].Sid + '\',\'' + Arr[i].Service + '\')" class="btn btn-primary btn-xs glyphicon glyphicon-edit" title="Edit"></button> | <button type="button" onclick="ConfirmBookingPopup(' + Arr[i].Sid + ')" class="btn btn-primary btn-xs glyphicon glyphicon-ok" title="Confirm"></button></td>'
                    }
                    Div += '</td>'
                    Div += '</tr>'
                }
