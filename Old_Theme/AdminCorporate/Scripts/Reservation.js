...
var LateNightFixCharges = 15, Adult = 0, Child = 0, CardProcessingPercent = 0, CardProcessingAmount = 0;
        ...
        success: function (response) {
            ...
            if (obj.retCode == 1) {
                ...
                if (ReservationDetail.Service == 'Frederick-From Airport' || ReservationDetail.Service == 'Frederick-To Airport') {
                    $('#Adults').val(ReservationDetail.Adults)
                    $('#Childs').val(ReservationDetail.Childs)
                    if (ReservationDetail.Service == 'Frederick-From Airport')
                    {
                        ...
                        $('#SelExtraBag').val(ReservationDetail.ExtraBags)
                        $('#ExtraBagAmount').val(ReservationDetail.ExtraBagCharge)
                        $('#ExtraAdultPrice').val(ReservationDetail.AdultCharge)
                        $('#ExtraChildPrice').val(ReservationDetail.ChildCharge)
                    }
                    else
                    {
...
function CalcTotal(tot) {
    ...
    //Card Processing Fee
    if (CardProcessingAmount != 0) {
        Total = parseFloat((parseFloat(Total) + parseFloat(CardProcessingAmount)).toFixed(2));
    }
