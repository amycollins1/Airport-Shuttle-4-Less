        ...
        success: function (response) {
            ...
            if (obj.retCode == 1) {
                ...
                for (var i = 0; i < Arr.length; i++) {
                    ...
                    {
                        Div += '<td><button type="button" onclick="RedirectToUpdate(\'' + Arr[i].Sid + '\',\'' + Arr[i].Service + '\')" class="btn btn-xs glyphicon glyphicon-edit" title="Edit"></button> | <button type="button" onclick="ConfirmBookingPopup(' + Arr[i].Sid + ')" class="btn btn-xs glyphicon glyphicon-ok" title="Confirm" Disabled="Disabled"></button> | <button type="button" onclick="CancelReservation(' + Arr[i].Sid + ')" class="btn btn-xs glyphicon glyphicon-remove" title="Cancel"></button> | <button type="button" onclick="Delete(' + Arr[i].Sid + ')" class="btn btn-xs glyphicon glyphicon-trash" title="Delete"></button> | <button type="button" onclick="CompleteBooking(' + Arr[i].Sid + ')" class="btn btn-xs glyphicon glyphicon-check" title="Complete"></button></td>'
                    }
                    else
                    {
                        Div += '<td><button type="button" onclick="RedirectToUpdate(\'' + Arr[i].Sid + '\',\'' + Arr[i].Service + '\')" class="btn btn-xs glyphicon glyphicon-edit" title="Edit"></button> | <button type="button" onclick="ConfirmBookingPopup(' + Arr[i].Sid + ')" class="btn btn-xs glyphicon glyphicon-ok" title="Confirm"></button> | <button type="button" onclick="CancelReservation(' + Arr[i].Sid + ')" class="btn btn-xs glyphicon glyphicon-remove" title="Cancel"></button> | <button type="button" onclick="Delete(' + Arr[i].Sid + ')" class="btn btn-xs glyphicon glyphicon-trash" title="Delete"></button> | <button type="button" onclick="CompleteBooking(' + Arr[i].Sid + ')" class="btn btn-xs glyphicon glyphicon-check" title="Complete"></button></td>'
                    }
                    Div += '</td>'
                    Div += '</tr>'
                }
