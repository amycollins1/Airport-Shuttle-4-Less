    ...
    public class EmailManager
    {
        public static string MailCredentials(string To, bool IsCC, string Body, string Subject)
        {
            ...
            try
            {
                ...
                message.To.Add(To);
                if (IsCC)
                    message.CC.Add("airportshuttle4less@gmail.com,amy.collins244@gmail.com");
        ...
        public static string CommentMail(string Name, string Email, string Phone, string Message)
        {
            ...
            string Res = MailCredentials("airportshuttle4less@gmail.com,amy.collins244@gmail.com", false, EmailTemplate, "Comment Mail");
            return Res;
        }
        ...
        public static string EnquiryMail(string Name, string MobileNo, string Email, string Message)
        {
            ...
            string Res = MailCredentials("airportshuttle4less@gmail.com,amy.collins244@gmail.com", false, EmailTemplate, "Enquiry Mail");
            return Res;
        }
