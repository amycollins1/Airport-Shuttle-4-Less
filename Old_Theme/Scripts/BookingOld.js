...
function ResetCalculation()
{
    ...
    if (MySearch.ChkRetReservation) {
        Total = ((parseFloat(SubTotal) * 2) + parseFloat(nSnowCharge) + parseFloat(nGratuityCharge) + parseFloat(nExtraBagCharge) + parseFloat(nExtraAdultCharge) + parseFloat(nExtraChildCharge) + parseFloat(nChildSeatCharge)) - parseFloat(nOfferCharge);
    }
    else {
        Total = (parseFloat(SubTotal) + parseFloat(nSnowCharge) + parseFloat(nGratuityCharge) + parseFloat(nExtraBagCharge) + parseFloat(nExtraAdultCharge) + parseFloat(nExtraChildCharge) + parseFloat(nChildSeatCharge)) - parseFloat(nOfferCharge);
    }     
}
