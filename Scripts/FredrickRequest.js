...
function SubmitFredrick() {
    if (typeof isLocalTest !== 'undefined' && isLocalTest) {
...
function ValidationFredrick() {
    ...
    AirportSelect = $("#FredrickAirPort  option:selected").val();
    FredrickSelect = $("#FredrickLocation option:selected").val();

    FredrickDate = $('#txt_FredrickDate').val();
    ...
    var Pickuptime = $("#Pickup_FredrickHour option:selected").text() + ":" + $("#Pickup_FredrickMinutes option:selected").text() + ":" + $("#Pickup_FredrickAM_PM option:selected").text();

    var Return_Date = $("#Return_FredrickDate").val();
    if (FredrickService == "From Airport")
        Return_Date = $("#Return_FredrickDateFrom").val();
    var RetFlightNo = $("#FredrickFlightNumber").val();
    var Ret_Airlines = $("#Select_FredricksAirline").val();
    var Ret_FlightTime = $("#Flight_FredrickHour option:selected").text() + ":" + $("#Flight_FredrickMinutes option:selected").text() + ":" + $("#Flight_FredrickAM_PM option:selected").text();
    var From_FlightNumber = $("#FredrickFlightNumber").val(); 
    ...
    var FredrickAddress = $('#FredrickAddress').val();
    if (FredrickService == "From Airport")
    {
    ...
    MySearch = {
        ...
        FredrickAddress: FredrickAddress,
    };
