...
// DOM ready wrapper for all initialization
$(function() {
    //LoadAllComment();
...
function Validation() {
    if (Tab == 1) {
        ...
        if ($("#Service option:selected").val() == "From Airport" && FlightNo == '') {
            alert('Please Enter Flight Number')
            return false;
        }
        if ($("#Service option:selected").val() == "From Airport" && Airlines == '') {
